...
public class FundTransferCtl extends BaseCtl {
	...
	@PostMapping
	public String submit(@Valid @ModelAttribute("form")  FundTransferForm form,HttpSession session, BindingResult bindingResult,
			Model model) {
	...
	public String searchList(@ModelAttribute("form") FundTransferForm form,
		...
		if (OP_RESET.equalsIgnoreCase(operation)) {
			return "redirect:/ctl/fundTransfer/search";
		}
